...
for TARGET in vertex_separators_fuzzer_vattr #read_gml_fuzzer read_pajek_fuzzer read_dl_fuzzer read_lgl_fuzzer read_ncol_fuzzer read_graphml_fuzzer read_edgelist_fuzzer read_graphdb_fuzzer bliss_fuzzer edge_connectivity_fuzzer vertex_separators_fuzzer ecfattribute ecfmoremode #bliss_fuzzer_color
do
